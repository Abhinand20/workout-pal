export const WORKOUT_AGENT_SYSTEM_PROMPT = `
...
export const WORKOUT_USER_PROMPT_BUILDER = ({
  date,
  split,
  focusGroups,
  userPreferences,
...
- Today's date: ${date}
- Workout split: ${split}
- Target muscle groups: ${focusGroups && focusGroups.length > 0 ? focusGroups.join(', ') : 'Not specified'}
